...
<div class="container-fluid catalogItems">
    ...
    <div class="row catalogItem">
        ...
        <div class="col-md-1"><h4>Дата</h4></div>
        <div class="col-md-4"><h4>Продукты</h4></div>
        <div class="col-md-1"><h4>Стоимость</h4></div>
        <div class="col-md-1"><h4>Статус</h4></div>
        <div class="col-md-1"><h4>Действия</h4></div>
    </div>
    ...
    <div class="row catalogItem">
        ...
        <div class="col-md-3"><!--<c:out value="$ {order.products}"/>--></div>
